...
export default class portfolioForm extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            logo:"",
            editMode:false,
            apiUrl:"https://tannersmith.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
        };
    ...
    deleteImage(imageType){
        axios.delete(`https://tannersmith.devcamp.space/portfolio/delete-portfolio-image/${this.state.id}?image_type=${imageType}`, {withCredentials: true}
        ).then(response =>{
            this.setState({
                [`${imageType}_url`] : ""
            });
    ...
    componentDidUpdate(){
        if(Object.keys(this.props.portfolioToEdit).length > 0){
            ...
            this.setState({
                ...
                logo_url : logo_url || "",
                editMode: true,
                apiUrl:`https://tannersmith.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: 'patch',
                thumb_image_url: thumb_image_url || "",
                banner_image_url: banner_image_url || "",
                logo_url: logo_url || ""
